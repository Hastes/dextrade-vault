...
export function getAccountByAddress(accounts: { address: string }[] = [], targetAddress = '') {
...
export const toHumanReadableTime = (t: (v: string, args: any[]) => string, milliseconds: number) => {
...
export const sanitizeMessage = (msg: string, primaryType: string, types: any) => {
  if (!types) {
