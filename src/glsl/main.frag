...
void main() {
    ...
    // colors
    vec4 colors[] = vec4[](
        vec4(0.1196078431372549, 0.027450980392156862, 0.09235294117647059, 0.7)
        // vec4(1, 1, 1, 0.7)
    ...
    RadialGradient gradients[] = RadialGradient[](
        RadialGradient(0.3, colors[0], vec2( w / 2.0 + 50. * sin(.2 * iTime - 0.44), h / 2.0 - 50. * sin(.13 * iTime - 0.44)))
    ...
    vec3 color = vec3(0.0196078431372549, 0.027450980392156862, 0.08235294117647059);
